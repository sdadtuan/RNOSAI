...
class Wave4PlusGateTests(unittest.TestCase):
    def test_wave4_plus_gates_pass(self) -> None:
        with patch.dict(
            os.environ,
            {
        ...
        self.assertIn("W4P-G07", ids)

    def test_wave4_plus_modules_partial(self) -> None:
        for mid in ("sales", "kpi", "staff", "proposals", "payroll"):
