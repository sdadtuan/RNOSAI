...
@Injectable()
export class StaffHrEmployeeFileViewGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!this.staffAuth.hasCap(me.caps, 'crm_staff_roster', 'view')) {
...
@Injectable()
export class StaffHrEmployeeFileWriteGuard implements CanActivate {
  constructor(private readonly staffAuth: StaffAuthService) {}
