...
@Injectable()
export class StaffHrDocsApproveGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!this.staffAuth.hasCap(me.caps, 'crm_hr_docs', 'approve')) {
...
@Injectable()
export class StaffHrWalletSelfGuard implements CanActivate {
  constructor(private readonly staffAuth: StaffAuthService) {}
