...
function samplePayload(over: Partial<TowerPayload> = {}): TowerPayload {
  return {
    ...
    k_strip: [
      { key: 'k1', value: 12, status: 'green', href: '/crm/internal-reports/dashboards?role=bod' },
      { key: 'k2', value: 3, status: 'amber', href: '/crm/internal-reports/dashboards?role=bod' },
      { key: 'k3', value: 1, status: 'red', href: '/crm/internal-reports/dashboards?role=bod' },
      { key: 'k4', value: null, status: 'neutral', href: '/crm/internal-reports/dashboards?role=bod' },
    ],
    columns: [
      {
        column_id: 'lead_b2',
