...
@Injectable()
export class StaffEmailComplianceGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const compliance = this.staffAuth.hasCap(me.caps, 'crm_email_mkt', 'compliance');
