...
export const LINK_ICONS: Record<string, string> = {
  ...
  '/crm/kpi-hub/service-kpi': 'dashboard',
  '/crm/kpi-hub/service-templates': 'metric',
  '/crm/kpi-hub/instances': 'kpi',
  '/crm/kpi-hub/measurement': 'catalog',
  '/crm/kpi-hub/tracking': 'report',
  '/crm/kpi-hub/kpi-contracts': 'health',
  '/crm/kpi-hub/reconcile': 'report',
  '/crm/kpi-hub/policy-packs': 'catalog',
  '/crm/kpi-hub/performance': 'dashboard',
  '/crm/kpi-hub/performance/assignments': 'kpi',
  '/crm/kpi-hub/performance/scorecards': 'metric',
  '/crm/kpi-hub/performance/check-ins': 'health',
  '/crm/kpi-hub/performance/campaigns': 'report',
  '/crm/kpi-hub/performance/crm-source': 'catalog',
...
export const SECTION_LABELS: Record<string, string> = {
  ...
  'CRM · Bán hàng & Hợp đồng': 'Hợp đồng',
