#!/usr/bin/env bash
# Deploy Creative Production OS Wave 1 — DDL + catalog + ptt-crm-api + ops-web.
# Do NOT export CP_AI_ENABLED=1 — W1 render stays stub until UAT signoff is green.
