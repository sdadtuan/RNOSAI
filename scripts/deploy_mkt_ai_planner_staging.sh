...
run_local() {
  ...
  echo "Flags: PTT_MKT_AI_PLANNER_ENABLED=1 PTT_MKT_AI_PLANNER_SLUGS=meta-lead-gen PTT_MKT_AI_RAG_ENABLED=1 PTT_MKT_AI_APPROVAL_REQUIRED=1 NEXT_PUBLIC_MKT_AI_PLANNER=1"
